describe("GPS", [](){
	...
	it("GGA frame parser test", [&](){
		...
		AssertThat(gps_time.tm_hour, Equals(6));
		AssertThat(gps_time.tm_min, Equals(50));
		AssertThat(gps_time.tm_sec, Equals(22));

		AssertThat(GPS::get_instance().get_satellites(), Equals(5));
		AssertThat(GPS::get_instance().get_latitude(), Is().EqualToWithDelta(45.308070833, 0.00001));
		AssertThat(GPS::get_instance().get_longitude(), Is().EqualToWithDelta(-1.226565, 0.00001));

		AssertThat(GPS::get_instance().get_HDOP(), Is().EqualToWithDelta(2.33, 0.0005));
		AssertThat(GPS::get_instance().get_altitude(), Is().EqualToWithDelta(10202.2, 0.0005));
	});
	...
	it("GGA frame parser pass test", [&](){
		...
		AssertThat(GPS::get_instance().get_time().tm_hour, Equals(5));
		AssertThat(GPS::get_instance().get_time().tm_min, Equals(43));
		AssertThat(GPS::get_instance().get_time().tm_sec, Equals(20));
	...
	it("GSA frame parser test", [&](){
		...
		AssertThat(GPS::get_instance().is_fixed(), Equals(true));
		AssertThat(GPS::get_instance().get_PDOP(), Is().EqualToWithDelta(1.91, 0.0005));
		AssertThat(GPS::get_instance().get_HDOP(), Is().EqualToWithDelta(0.99, 0.0005));
		AssertThat(GPS::get_instance().get_VDOP(), Is().EqualToWithDelta(1.63, 0.0005));
	});
	...
	it("RMC frame parser test", [&](){
		...
		AssertThat(gps_time.tm_mday, Equals(7));
		AssertThat(gps_time.tm_mon, Equals(5));
		AssertThat(gps_time.tm_year, Equals(116));
		AssertThat(gps_time.tm_hour, Equals(8));
		AssertThat(gps_time.tm_min, Equals(32));
		AssertThat(gps_time.tm_sec, Equals(50));
	...
	it("RMC frame parser pass test", [&](){
		...
		AssertThat(new_gps_time.tm_hour, Equals(9));
		AssertThat(new_gps_time.tm_min, Equals(30));
		AssertThat(new_gps_time.tm_sec, Equals(24));
		AssertThat(new_gps_time.tm_mday, Equals(6));
		AssertThat(new_gps_time.tm_mon, Equals(4));
		AssertThat(new_gps_time.tm_year, Equals(115));
