...
pkgdatadir = $(datadir)/openstratos
pkgincludedir = $(includedir)/openstratos
pkglibdir = $(libdir)/openstratos
pkglibexecdir = $(libexecdir)/openstratos
...
ACLOCAL = ${SHELL} /home/razican/workspace/os-server/missing aclocal-1.14
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} /home/razican/workspace/os-server/missing autoconf
...
OBJEXT = o
PACKAGE = openstratos
PACKAGE_BUGREPORT = https://github.com/OpenStratos/server/issues
PACKAGE_NAME = OpenStratos
PACKAGE_STRING = OpenStratos 0.0.1-SNAPSHOT
PACKAGE_TARNAME = openstratos
PACKAGE_URL = 
...
abs_builddir = /home/razican/workspace/os-server
...
install_sh = ${SHELL} /home/razican/workspace/os-server/install-sh
...
stamp-h1: $(srcdir)/config.hpp.in $(top_builddir)/config.status
	@rm -f stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status config.hpp
...
check-am: all-am
check: check-am
all-am: Makefile $(PROGRAMS) config.hpp
installdirs:
